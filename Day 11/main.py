...
def calculate_score(cards_list):
    """Take a list of cards and generate a score from the cards"""
...
def compare(userScore, computerScore):
    """Returns the comparison message of two scores"""
...
def blackjack():
    ...
    while not is_game_over:
        ...
        #  function to add another card to the user_cards List. If no, then the game has ended.
            ...
            if (
                input("Do you want to deal a new card? Type 'y' or 'n' : ").lower()
                == "y"
            ):
                user_cards.append(deal_card())
            else:
